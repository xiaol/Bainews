...
public class HttpConstant {
    public static final String URL_GET_NEWS_LIST="http://api.deeporiginalx.com/news/baijia/newsFetchHome";
    ...
    public static final String URL_GET_NEWS_DETAIL_NEW="http://api.deeporiginalx.com/news/baijia/newsFetchContent?url=";
