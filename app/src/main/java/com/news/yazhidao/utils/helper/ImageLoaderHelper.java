...
public class ImageLoaderHelper {
    ...
    public static DisplayImageOptions getOption() {
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.bg_load_default_big) //设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.drawable.bg_load_default_big)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.bg_load_default_big)  //设置图片加载/解码过程中错误时候显示的图片
