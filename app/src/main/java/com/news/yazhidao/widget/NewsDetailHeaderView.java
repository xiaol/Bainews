...
public class NewsDetailHeaderView extends FrameLayout implements CommentPopupWindow.IUpdateCommentCount, InputbarPopupWindow.IUpdateCommentCount, CommentPopupWindow.IUpdatePraiseCount {
    ...
    private ShowAllListview lv_article;
    ...
    private TextView tv_devider_imgwall;
    private TextView tv_devider_baike;
    ...
    private ShowAllListview lv_newsdetail;
    private MyArticleAdapter al_adapter;
    private NewsDetailAdapter newsDetailAdapter;
    private NewsDetailAddAdapter newsDetailAddAdapter;
    ...
    private ArrayList<LinkedTreeMap<String, HashMap<String, String>>> maps = new ArrayList<LinkedTreeMap<String, HashMap<String, String>>>();
    ...
    private void findViews() {
        ...
        lv_article = (ShowAllListview) mRootView.findViewById(R.id.lv_article);
        mllBaiKe = (LinearLayout) mRootView.findViewById(R.id.baike_linerLayout);
        tv_devider_baike = (TextView) mRootView.findViewById(R.id.tv_devider_baike);
        ...
        tv_devider_zhihu = (TextView) mRootView.findViewById(R.id.tv_devider_zhihu);
        tv_devider_douban = (TextView) mRootView.findViewById(R.id.tv_devider_douban);
        ...
        lv_newsdetail = (ShowAllListview) mRootView.findViewById(R.id.lv_newsdetail);
...
//        mNewsDetailHeaderLocation = (TextView) mRootView.findViewById(R.id.mNewsDetailHeaderLocation);//新闻发生的地点
    ...
    @Override
    public void updateCommentCount(int count, final int paragraphIndex, NewsDetail.Point point, int flag, boolean isPraiseFlag) {
                    ...
                    if (flag == PARA_FLAG) {
                        ...
                        rl_comment.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                RelativeLayout rl_aa = (RelativeLayout) lv_newsdetail.getChildAt(paragraphIndex);
                                int para_index = (int) paragraphIndex;
...
//                                        v.setVisibility(View.GONE);
    ...
    private void inflateNewsDetailAddHeaderView(NewsDetailAdd pNewsDetail) {
        ...
        if (((NewsDetailAdd) pNewsDetail).content != null) {
            ...
            maps = ((NewsDetailAdd) pNewsDetail).content;
            newsDetailAddAdapter = new NewsDetailAddAdapter();
            lv_newsdetail.setAdapter(newsDetailAddAdapter);
...
//                        modifyNewsContent(((NewsDetail)pNewsDetail), type, srcText, mNewsDetailEdittext.getText().toString(), EDIT_POSITION);
    ...
    private void inflateNewsDetailHeaderView(NewsDetail pNewsDetail) {
        ...
        lv_newsdetail.setAdapter(newsDetailAdapter);
    }
        ...
        if (!isnew) {
            ...
            if (pNewsDetail != null) {
                ...
                if (pArrBaiDuBaiKe != null && pArrBaiDuBaiKe.size() > 0) {
                    ...
                    tv_devider_baike.setVisibility(View.GONE);
                }
                //图片墙的相关显示
                ...
                if (((NewsDetail) pNewsDetail).imgWall != null) {
                    ...
                    tv_devider_imgwall.setVisibility(View.GONE);
                }

                if (((NewsDetail) pNewsDetail).relate_opinion != null) {
                    relate_opinion = ((NewsDetail) pNewsDetail).relate_opinion;
                    self_opinion = relate_opinion.getSelf_opinion();
                    al_adapter = new MyArticleAdapter();
                    lv_article.setDivider(null);
                    lv_article.setAdapter(al_adapter);

                } else {
                    lv_article.setVisibility(View.GONE);
                }
                ...
                if (pArrZhiHu != null && pArrZhiHu.size() > 0) {
                    ...
                    tv_devider_zhihu.setVisibility(View.GONE);
                }
                ...
                if (pArrDouBan != null && pArrDouBan.size() > 0) {
                    ...
                    tv_devider_douban.setVisibility(View.GONE);
                }
                ...
                if (pArrWeibo != null && pArrWeibo.size() > 0) {
                    ...
                    tv_devider_sina.setVisibility(View.GONE);
                }
            }
    ...
    private class MyArticleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.ll_article_item, null, false);
                holder.ll_new_card = (LinearLayout) convertView.findViewById(R.id.ll_new_card);
                holder.ll_new_card.setOnClickListener(new OnClickListener() {
                    long firstClick = 0;
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("url", self_opinion.get(position).url);
                        mContext.startActivity(intent);
                    }
                });
                holder.tv_url = (LetterSpacingTextView) convertView.findViewById(R.id.tv_url);
                holder.tv_url.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
                holder.tv_article_des = (LetterSpacingTextView) convertView.findViewById(R.id.tv_article_des);
                holder.tv_article_des.setLineSpacing(DensityUtil.dip2px(mContext, 24), 0);
                holder.tv_article_des.setFontSpacing(1);
                holder.tv_article_des.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
                convertView.setTag(holder);
            } else {
                holder = (ArticleHolder) convertView.getTag();
            }
            final NewsDetail.Article article = self_opinion.get(position);

            if (article != null && article.self_opinion != null) {
                holder.tv_article_des.setText(article.self_opinion);
            }

            if (article != null && article.url != null) {
                holder.tv_url.setText(article.title);
            }
            return convertView;
        }
    }
    ...
    private class NewsDetailAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                //段落和评论布局
                newsdetailViewHolder.rl_para = (RelativeLayout) convertView.findViewById(R.id.rl_para);
                newsdetailViewHolder.rl_comment_content = (RelativeLayout) convertView.findViewById(R.id.rl_comment_content);
                newsdetailViewHolder.lstv_para_content = (LetterSpacingTextView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.lstv_para_content);
                newsdetailViewHolder.tv_praise_count = (TextView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.tv_praise_count);
                newsdetailViewHolder.iv_user_icon = (RoundedImageView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.iv_user_icon);
                newsdetailViewHolder.rl_comment = (RelativeLayout) newsdetailViewHolder.rl_comment_content.findViewById(R.id.rl_comment);
                newsdetailViewHolder.iv_add_comment = (ImageView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.iv_add_comment);
                newsdetailViewHolder.iv_none_point = (ImageView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.iv_none_point);
                newsdetailViewHolder.tv_comment_count = (TextView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.tv_comment_count);
                newsdetailViewHolder.tv_comment_content = (TextView) newsdetailViewHolder.rl_comment_content.findViewById(R.id.tv_comment_content);
                newsdetailViewHolder.tv_devider = (TextView) convertView.findViewById(R.id.tv_devider);
            ...
            if (_Split[position] != null && !"".equals(_Split[position])) {
                ...
                newsdetailViewHolder.rl_comment.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
...
//                                        speechView.setVisibility(View.GONE);
                                if (position == Integer.parseInt(point.paragraphIndex)) {
                                    ...
                                    if (point != null && point.comments_count != null) {
                                        newsdetailViewHolder.tv_comment_count.setText(point.comments_count);
                                    } else {
                                        newsdetailViewHolder.tv_comment_count.setText("1");
                                    }
                                    if (TEXT_PARAGRAPH.equals(point.type)) {
                                        newsdetailViewHolder.tv_comment_content.setText(point.srcText);
                                    }

                                    if (point.userIcon != null && !"".equals(point.userIcon)) {
                                        ImageLoaderHelper.dispalyImage(mContext, point.userIcon, newsdetailViewHolder.iv_user_icon);
                                    }

                                    add_flag = true;
                                    newsdetailViewHolder.rl_comment.setVisibility(View.VISIBLE);
                                    newsdetailViewHolder.iv_none_point.setVisibility(View.GONE);
                                } else {
...
//            ToastUtil.toastLong("getview 执行时间：" + time);
    ...
    private class NewsDetailAddAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(mContext, R.layout.rl_content_and_comment_new, null);
                //段落和评论布局
                newsdetailAddViewHolder.rl_para = (RelativeLayout) convertView.findViewById(R.id.rl_para);
                newsdetailAddViewHolder.rl_comment_content = (RelativeLayout) convertView.findViewById(R.id.rl_comment_content);
                newsdetailAddViewHolder.lstv_para_content = (LetterSpacingTextView) convertView.findViewById(R.id.lstv_para_content);
                newsdetailAddViewHolder.tv_praise_count = (TextView) convertView.findViewById(R.id.tv_praise_count);
                newsdetailAddViewHolder.iv_user_icon = (RoundedImageView) convertView.findViewById(R.id.iv_user_icon);
                newsdetailAddViewHolder.rl_comment = (RelativeLayout) convertView.findViewById(R.id.rl_comment);
                newsdetailAddViewHolder.iv_add_comment = (ImageView) convertView.findViewById(R.id.iv_add_comment);
                newsdetailAddViewHolder.iv_none_point = (ImageView) convertView.findViewById(R.id.iv_none_point);
                newsdetailAddViewHolder.tv_comment_count = (TextView) convertView.findViewById(R.id.tv_comment_count);
                newsdetailAddViewHolder.tv_news_img_info = (TextView) convertView.findViewById(R.id.tv_news_img_info);
                newsdetailAddViewHolder.tv_comment_content = (TextView) convertView.findViewById(R.id.tv_comment_content);
                newsdetailAddViewHolder.tv_devider = (TextView) convertView.findViewById(R.id.tv_devider);
                newsdetailAddViewHolder.iv_news_des = (ImageView) convertView.findViewById(R.id.iv_news_des);
                convertView.setTag(newsdetailAddViewHolder);
            } else {
                newsdetailAddViewHolder = (NewsdetailAddViewHolder) convertView.getTag();
            }

            LinkedTreeMap<String, HashMap<String, String>> map = maps.get(position);
            String index = String.valueOf(position);
            HashMap<String, String> temp_map = map.get(index);

            if (temp_map != null) {
                if (temp_map.containsKey("img")) {
                    String url = temp_map.get("img");

                    newsdetailAddViewHolder.rl_comment_content.setVisibility(View.GONE);
                    newsdetailAddViewHolder.tv_news_img_info.setVisibility(View.GONE);
                    newsdetailAddViewHolder.iv_news_des.setVisibility(View.VISIBLE);

                    ImageManager.getInstance(mContext).DisplayImage(url, newsdetailAddViewHolder.iv_news_des, false, new DisplayImageListener() {
                        @Override
                        public void success(int width, int height) {
                        }
                    ...
                    if (position == 0) {
                        newsdetailAddViewHolder.iv_news_des.setVisibility(View.GONE);
                    }

                } else if (temp_map.containsKey("img_info")) {
                    newsdetailAddViewHolder.rl_comment_content.setVisibility(View.GONE);
                    newsdetailAddViewHolder.tv_news_img_info.setVisibility(View.VISIBLE);
                    newsdetailAddViewHolder.iv_news_des.setVisibility(View.GONE);

                    String img_info = temp_map.get("img_info");
                    if (img_info != null && img_info.length() > 0) {
                        img_info = "    " + img_info;
                        newsdetailAddViewHolder.tv_news_img_info.setText(img_info);
                        newsdetailAddViewHolder.tv_news_img_info.setTextColor(Color.BLACK);
                    }
                } else if (temp_map.containsKey("txt")) {
                    String para = temp_map.get("txt");
                    String text = BCConvert.bj2qj(para);

                    newsdetailAddViewHolder.rl_comment_content.setVisibility(View.VISIBLE);
                    newsdetailAddViewHolder.tv_news_img_info.setVisibility(View.GONE);
                    newsdetailAddViewHolder.iv_news_des.setVisibility(View.GONE);

                    if (text != null && text.length() > 0) {
                        setViewBg(newsdetailAddViewHolder.iv_none_point);
...
//                                        speechView.setVisibility(View.GONE);
                                        if (position == Integer.parseInt(point.paragraphIndex)) {
                                            ...
                                            if (point != null && point.comments_count != null) {
                                                newsdetailAddViewHolder.tv_comment_count.setText(point.comments_count);
                                            } else {
                                                newsdetailAddViewHolder.tv_comment_count.setText("1");
                                            }
                                            if (TEXT_PARAGRAPH.equals(point.type)) {
                                                newsdetailAddViewHolder.tv_comment_content.setText(point.srcText);
                                            }

                                            if (point.userIcon != null && !"".equals(point.userIcon)) {
                                                ImageLoaderHelper.dispalyImage(mContext, point.userIcon, newsdetailAddViewHolder.iv_user_icon);
                                            }

                                            add_flag = true;
                                            newsdetailAddViewHolder.rl_comment.setVisibility(View.VISIBLE);
                                            newsdetailAddViewHolder.iv_none_point.setVisibility(View.GONE);
                                        } else {
                                            newsdetailAddViewHolder.rl_comment.setVisibility(View.GONE);
                                            newsdetailAddViewHolder.iv_none_point.setVisibility(View.VISIBLE);
                                        }
...
//                                              window.setBackgroundDrawable(new BitmapDrawable());
    ...
    class ArticleHolder {
        LetterSpacingTextView tv_article_des;
        LetterSpacingTextView tv_url;
    ...
    class NewsdetailAddViewHolder {
        ...
        ImageView iv_add_comment;
        TextView tv_comment_count;
        TextView tv_news_img_info;
        TextView tv_comment_content;
        TextView tv_devider;
        ImageView iv_news_des;
    }
