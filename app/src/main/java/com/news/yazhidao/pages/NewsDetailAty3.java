...
//        mlvRelate.setAdapter(mNewsDetailAdapter);
    ...
    protected void loadData() {
        ...
        if (NetUtil.checkNetWork(NewsDetailAty3.this)) {
    ...
    private void loadNewsDetail() {
        ...
        User user = SharedPreManager.getUser(NewsDetailAty3.this);
        if (user != null) {
            ...
            _Request.setCallback(new JsonCallback<NewsDetail>() {
                ...
                public void success(final NewsDetail result) {
                    if (result != null) {
                        ...
                        View headerGroupView = View.inflate(NewsDetailAty3.this,R.layout.item_group_header,null);
