...
public class SubActionButton extends FrameLayout {
    ...
    public void setContentView(View contentView, FrameLayout.LayoutParams params) {
        if(params == null) {
            int actionBtnSize = getResources().getDimensionPixelSize(R.dimen.action_button_size);
            params = new FrameLayout.LayoutParams(actionBtnSize, actionBtnSize, Gravity.CENTER);
